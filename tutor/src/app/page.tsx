        ...
        <div style={styles.heroContent}>
          <div style={styles.heroLeft}>
            ...
            <p style={styles.description}>
              Founded in 2023 by Muhammad Usman Ashfaq, QUNO CAMPUS provides personalized one-on-one online tutoring 
              for all curricula including GCSSC, IGCSE, AP, and more. Experience our innovative learning platform 
              with 24/7 support, free trial sessions, and specialized programming courses.
            </p>
            </div>
