    ...
    <div style={styles.container}>
          ...
          <div style={styles.heroLeft}>
            ...
            <div>
              <p style={styles.description}>
                Founded in 2023 by Muhammad Usman Ashfaq, QUNO CAMPUS combines
                academic excellence with modern technology to create an engaging
                learning environment. Our platform supports students 24/7,
                offering free trial sessions anytime, daily lectures, weekly
                tests, and monthly parent-teacher meetings (PTMs). Feedback and
                progress reports ensure transparent communication with parents.
              </p>
            </div>
      ...
      <section style={styles.howItWorksSection}>
        <div style={styles.sectionHeader}>
          ...
          <p style={styles.sectionSubtitle}>
            Experience our comprehensive learning platform with personalized
            support and continuous assessment
          </p>
        </div>
        ...
        <div style={styles.stepsContainer}>
          <div style={styles.step}>
            ...
            <p style={styles.stepDescription}>
              Schedule a free trial session anytime, 24/7, to experience our
          ...
          <div style={styles.step}>
            ...
            <p style={styles.stepDescription}>
              Receive unique credentials to access our ERP portal with lectures,
              schedules, and study materials.
            </p>
          </div>
          ...
          <div style={styles.step}>
            ...
            <p style={styles.stepDescription}>
              Monitor progress through weekly tests and monthly parent-teacher
              meetings for transparent communication.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={styles.coursesSection}>
        <div style={styles.sectionHeader}>
          ...
          <p style={styles.sectionSubtitle}>
            Comprehensive range of academic subjects and practical skill
            development courses
          </p>
        </div>
      ...
      <section style={styles.servicesSection}>
        <div style={styles.sectionHeader}>
          ...
          <p style={styles.sectionSubtitle}>
            From academic tutoring to skill development with continuous
        ...
        <div style={styles.servicesGrid}>
          <div style={styles.serviceCard}>
            ...
            <p style={styles.serviceDescription}>
              One-on-one online tutoring for all curricula including GCSSC,
              IGCSE, AP, and others with personalized attention.
            </p>
          ...
          <div style={styles.serviceCard}>
            <img
              ...
              alt="skill based courses "
              style={styles.serviceIcon}
            />
            <h3 style={styles.serviceTitle}>Skill-Based Courses</h3>
            <p style={styles.serviceDescription}>
              Practical skill development courses including programming
              languages such as Python, C++, and more.
            </p>
            <ul style={styles.serviceFeatures}>
          ...
          <div style={styles.serviceCard}>
            ...
            <p style={styles.serviceDescription}>
              Unique credentials for ERP portal access with daily lectures,
              weekly tests, and monthly PTMs.
            </p>
            <ul style={styles.serviceFeatures}>
        ...
        <div style={styles.whyChooseGrid}>
          <div style={styles.whyChooseItem}>
            ...
            <p style={styles.whyChooseDescription}>
              Qualified professionals with proven track record and teaching
              certifications.
            </p>
          </div>
      ...
      <section style={styles.testimonialsSection}>
        <div style={styles.sectionHeader}>
          ...
          <p style={styles.sectionSubtitle}>
            Real success stories from students who transformed their academic
            journey
          </p>
        </div>
        ...
        <div style={styles.testimonialsGrid}>
          <div style={styles.testimonialCard}>
            ...
            <p style={styles.testimonialText}>
              "The ERP portal access and weekly tests helped me track my
              progress effectively. The monthly PTMs keep my parents
              well-informed about my academic journey."
            </p>
            <div style={styles.testimonialAuthor}>
              <strong style={styles.authorName}>Aisha Khan</strong>
              <span style={styles.authorInfo}>
                IGCSE Student - All Subjects
              </span>
            </div>
          </div>
          ...
          <div style={styles.testimonialCard}>
            <div style={styles.starRating}>★★★★★</div>
            <p style={styles.testimonialText}>
              "The Python and C++ programming courses at QUNO CAMPUS are
              excellent. The hands-on learning approach prepared me for modern
              career demands."
            </p>
            <div style={styles.testimonialAuthor}>
              <strong style={styles.authorName}>Ahmed Hassan</strong>
              <span style={styles.authorInfo}>
                AP Student - Computer Science
              </span>
            </div>
          </div>
          ...
          <div style={styles.testimonialCard}>
            <div style={styles.starRating}>★★★★★</div>
            <p style={styles.testimonialText}>
              "The free trial session convinced me to enroll. The 24/7 support
              and multichannel communication make learning accessible anytime."
            </p>
            <div style={styles.testimonialAuthor}>
