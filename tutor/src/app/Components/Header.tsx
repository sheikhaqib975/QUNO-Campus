  ...
  >
    <img src={linkedin.src} alt="LinkedIn" width={16} height={16} style={styles.iconWhite} />
      ...
      <nav style={styles.navbar}>
        ...
        >
          <Link href="/" style={styles.mobileLink} onClick={() => setOpen(false)}>
            Home
          </Link>
          <Link href="/courses" style={styles.mobileLink} onClick={() => setOpen(false)}>
            Courses
          </Link>
          <div style={styles.mobileDropdownContainer}>
            ...
            <div style={styles.mobileDropdown}>
              <Link href="/sat" style={styles.mobileDropdownItem} onClick={() => setOpen(false)}>
                SAT/ACT
              </Link>
              <Link href="/gre" style={styles.mobileDropdownItem} onClick={() => setOpen(false)}>
                NAPLAN
              </Link>
            </div>
          </div>
          <Link href="/about" style={styles.mobileLink} onClick={() => setOpen(false)}>
            About Us
          </Link>
          ...
          <Link href="/signup" style={styles.mobileLink} onClick={() => setOpen(false)}>
            Sign Up
          </Link>
        </div>
      </nav>
